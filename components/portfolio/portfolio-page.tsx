      ...
      <div className="container pt-8 pb-20">
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-medium text-black dark:text-white mb-4">
            Unser <span className="text-[#7A7FEE]">Portfolio</span>
          </h1>
          <p className="text-gray-700 dark:text-gray-300 max-w-2xl">
            Entdecken Sie unsere neuesten Projekte und Erfolgsgeschichten. Von KI-gestützter Automatisierung bis zu
            massgeschneiderten Lösungen – unsere Arbeit hilft Schweizer Unternehmen, digital zu wachsen.
          </p>
        </div>
