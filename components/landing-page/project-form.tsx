        ...
        <div className="bg-[#3a3a3a] rounded-2xl p-6 md:p-8 shadow-lg">
          ...
          <div className="mb-8">
            <p className="text-white text-base md:text-lg leading-relaxed">
              Beantworten Sie einige Fragen zu Ihrem Projekt und vereinbaren Sie dann ein Gespräch mit Ihrem
              Projektmanager.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="firstName" className="block text-white text-sm font-medium mb-3">
                Wie ist Ihr Vorname? <span className="text-red-400">*</span>
              </label>
            ...
            <div>
              <label htmlFor="lastName" className="block text-white text-sm font-medium mb-3">
                Ihr Nachname? <span className="text-red-400">*</span>
              </label>
              <input
                type="text"
                id="lastName"
            ...
            <div>
              <label htmlFor="email" className="block text-white text-sm font-medium mb-3">
                Wie ist Ihre E-Mail? <span className="text-red-400">*</span>
              </label>
              <input
                type="email"
                id="email"
